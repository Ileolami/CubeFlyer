...
class MainMenu extends GameObject {
    ...
    createMainMenu() {
        ...
        this.background = new BABYLON.GUI.Image("background", "../img/use-svg-as-background-image-particle-strokes.svg");
        this.background.stretch = BABYLON.GUI.Image.STRETCH_UNIFORM;
        this.hudTexture.addControl(this.background);
    }
    ...
    getGreeting() {
   	...
   	showUI() {
		...
		// Create a background image for the UI
		this.backgroundImage = new BABYLON.GUI.Image("background", "img/background.jpg");
		this.backgroundImage.stretch = BABYLON.GUI.Image.STRETCH_UNIFORM;
		this.backgroundImage.width = "100%";
		this.backgroundImage.height = "100%";
		this.hudTexture.addControl(this.backgroundImage);
		...
		this.welcomeText.height = 0.6;// Adjust top margin for better spacing
		...
		this.greetingText.top = "30px";// Adjust top margin for better spacing
		
		this.instructionsText = new BABYLON.GUI.TextBlock();
		this.instructionsText.text = "Press any key to play";
		this.instructionsText.fontFamily = "Arial"; // Example: change font to Arial
		...
		this.instructionsText.top = "40px"; // Adjust top margin for better spacing // Adjust top margin for better spacing
    ...
    hideUI() {
        ...
        this.hudTexture.removeControl(this.background);
    }
}
